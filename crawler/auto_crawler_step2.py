...
def get_info_service(file_csv):
    ...
    for iteration in range(total_rows):
        ...
        print(f"\n--- Iterazione {iteration}/{total_rows} ---")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Auto Crawler IFTTT")
    parser.add_argument("csv_path", help="Percorso del file CSV di input")
    parser.add_argument("output_path", help="Percorso del file JSON di output")
    args = parser.parse_args()

    FILE_CSV = args.csv_path
    ...
    try:
        correct, prompt_data = get_info_service(file_csv=FILE_CSV)
