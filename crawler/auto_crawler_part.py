...
OUTPUT_PATH = f"{base_dir}/data/generated_prompt_data_cais_part2.json"
...
# === MAIN ===
def get_info_service(start_idx=10000, end_idx=20000, file_csv=FILE_CSV):
    correct = 0
    prompt_data = []
    ...
    # Limita l'intervallo di righe da processare
...
if __name__ == "__main__":
    ...
    try:
        correct, prompt_data = get_info_service(10000, 20000)
